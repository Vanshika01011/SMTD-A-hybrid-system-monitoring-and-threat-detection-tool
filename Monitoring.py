...
class SplashScreen(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.label = tk.Label(self, text="SMTD - System Monitoring & Threat Detection", fg="white", bg="black", font=("Helvetica", 16, "bold"))
...
class LiveGraphFrame(ttk.Frame):
    def __init__(self, parent):
        ...
        self.ax2 = self.ax1.twinx()  # Secondary y-axis for network
        ...
        self.ax2.set_ylim(0, 1000)  # Adjustable as needed
        ...
        self.lines = [self.line_cpu, self.line_ram, self.line_disk, self.line_net]
    ...
    def update_graph(self, i):
        ...
        # Update Y limits for network axis dynamically
        max_net = max(self.net_data)
        self.ax2.set_ylim(0, max(500, max_net * 1.5))  # Auto-scale
...
class SMTDApp(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("SMTD - System Monitoring and Threat Detection")
    ...
    def set_theme(self, theme):
        bg, fg = ("#ffffff", "#000000") if theme == "light" else ("#1e1e1e", "#f5f5f5")
    ...
    def create_widgets(self):
        ...
        ttk.Label(top_frame, text="System Monitoring and Threat Detection", font=("Helvetica", 18, "bold")).pack(side="left", padx=10, pady=10)

        ttk.Button(top_frame, text="Toggle Theme", command=self.toggle_theme).pack(side="right", padx=10)

        # Real-time graph frame
        self.graph_frame = LiveGraphFrame(self)
